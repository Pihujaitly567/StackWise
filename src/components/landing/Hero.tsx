...
export function Hero() {
  return (
    <section className="relative overflow-hidden bg-mesh pt-20 pb-24 md:pt-28 md:pb-32 min-h-[90vh] flex flex-col justify-center">
      ...
      <div className="absolute inset-0 pointer-events-none opacity-20 dark:opacity-10 z-0 flex items-center justify-center">
        <svg width="100%" height="100%" viewBox="0 0 800 600" preserveAspectRatio="xMidYMid slice" className="animate-pulse">
          <path d="M 100 0 Q 300 150 100 300 T 100 600" fill="none" stroke="url(#gradient)" strokeWidth="8" className="animate-helix" opacity="0.3"/>
          <path d="M 700 0 Q 500 150 700 300 T 700 600" fill="none" stroke="url(#gradient)" strokeWidth="8" className="animate-helix" opacity="0.3"/>
          <defs>
      ...
      <div className="container mx-auto max-w-screen-xl px-4 relative z-10 flex flex-col lg:flex-row items-center gap-12 lg:gap-8">
        ...
        <div className="flex-1 flex flex-col items-center lg:items-start text-center lg:text-left">
          ...
          >
            ...
            <Link href="/results?demo=true" className="w-full sm:w-auto">
        ...
        <div className="flex-1 w-full relative h-[400px] lg:h-[500px] mt-12 lg:mt-0 flex items-center justify-center">
          ...
          <div className="relative w-full max-w-md mx-auto">
            ...
            >
              <Card className="glass-card glow-indigo border-white/50 overflow-hidden">
            ...
            >
              <Card className="glass-card border-white/50 overflow-hidden">
            ...
            >
              <Card className="glass-card glow-coral border-white/50 overflow-hidden">
            ...
            {/* Floating Icons */}
            <motion.div animate={{ y: [-5, 5, -5] }} transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }} className="absolute -left-12 top-0 bg-white dark:bg-black p-3 rounded-2xl shadow-lg border border-border">
              <Bot className="h-6 w-6 text-indigo-500" />
            </motion.div>
            <motion.div animate={{ y: [5, -5, 5] }} transition={{ duration: 5, repeat: Infinity, ease: "easeInOut" }} className="absolute -right-8 top-10 bg-white dark:bg-black p-3 rounded-2xl shadow-lg border border-border">
              <Sparkles className="h-6 w-6 text-purple-500" />
            </motion.div>
            <motion.div animate={{ y: [-8, 8, -8] }} transition={{ duration: 6, repeat: Infinity, ease: "easeInOut" }} className="absolute -left-4 bottom-10 bg-white dark:bg-black p-3 rounded-2xl shadow-lg border border-border">
              <Code2 className="h-6 w-6 text-blue-500" />
            </motion.div>
            <motion.div animate={{ y: [8, -8, 8] }} transition={{ duration: 4.5, repeat: Infinity, ease: "easeInOut" }} className="absolute right-12 bottom-0 bg-white dark:bg-black p-3 rounded-2xl shadow-lg border border-border">
